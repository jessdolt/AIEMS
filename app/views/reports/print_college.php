...
<html lang="en">
  ...
  <body id="element-to-print">
    ...
    <div class="" style="padding: 0">
      ...
      >
        <?php echo $x['college_name']?>
      </div>

      <div class="table-responsive">

        <?php foreach($x['data'] as $y) :?> 
        <div style="font-size: 15px; font-weight: bold"><?php echo $y['name']?> (<?= $y['courseCode'] ?>)</div>
          <?php foreach($y['data'] as $z) : ?>
            <div style="font-size: 12px; font-weight: bold">Batch <?php echo $z['year']?></div>
