                    ...
                    >
                      ...
                      <div class="p-2">
                        ...
                        >
                          ...
                          <a href="<?php echo URLROOT; ?>/pages/viewPromoAlumni/<?php echo $yourAdvertisement->promoid?>" class="btn rounded-pill text-white" data-id="<?php echo $yourAdvertisement->promoid ?>" id="btnView">View</a>
