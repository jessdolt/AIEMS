        ...
        <main class="admin managePage"><!-- remove cont-creator to access all-->
            ...
            <a href="<?php echo URLROOT?>/admin_manage/manage" class="back"> 
                ...
                <div class="header-con">
                    <h1>Manage Alumni Officer Accounts</h1>
                    <span>Add or Remove Alumni Officer Users</span>
                </div>
                <form action="" id="add-new-account" class="table-form">
                    <table class="data-table">
                        <?php if (!empty($data)) :?>
                        <?php if($url[1] != 'deleteRowAlumniOfficer'):?>
                        ...
                        <tr>
                            ...
                            <td><div class="option icon" tabindex="0">
                                ...
                                <div class="optionModal">
                                    <button type="button" class="btnDeleteAccount" data-id="<?php echo $admin->user_id ?>" data-url="<?php echo URLROOT?>/admin_manage/deleteRowAlumniOfficer">
                ...
                <div class="btn-con">
                    <a href="<?php echo URLROOT?>/admin_manage/addNewAo" class="changePass" form="add-new-account">Add New Account</a>
                </div>
            </section>
...
<div class="alertModalContainer <?php echo (isset($data['password_error'])) ? 'show' : ''?>">
        ...
        <div class="alertModal deleteAlert manage <?php echo (isset($data['password_error'])) ? 'show' : ''?>">
            ...
            <form action="" class="delete-acc-form" method="POST">
                ...
                <div>
                    <a href="<?php echo URLROOT ?>/admin_manage/aoAccounts" class="cancelBtn">Cancel</a>
