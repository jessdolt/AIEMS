        ...
        <main class="admin managePage">
          ...
          <section class="siteSettings">
            ...
            <form id="site-settings-form">
              ...
              <div>
                <label for="gcash" class="outsideLabel"
                  >GCash Number:</label
                >
                <div class="textFieldContainer">
                  <input
              ...
              <div>
                <label for="qrcode" class="outsideLabel"
                  >GCash QR Code:</label
                >
                <div
                  class="imageInputContainer_site"
                  style="max-width: 100rem !important"
                >
                  <?php echo !empty($data->qrcode) ? '<img src='.URLROOT.'/uploads/'. $data->qrcode .' id="qrcode_container"/> ': '<img src=" " id="qrcode_container">'  ?>
                  <label for="qrcode_img" class="fileUploadBtn">
                    Upload
                    <svg
                      viewBox="0 0 18 18"
                      fill="none"
                  ...
                  <input
                    ...
                    name="newsImageInput"
                    id="qrcode_img"
                    <?= !empty($data->qrcode) ? 'value='. $data->qrcode. '': " " ?> 
